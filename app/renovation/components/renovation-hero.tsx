      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <ScrollReveal direction="fade" delay={0.1}>
          <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 mb-8">
            ...
            <span className="text-white/80 text-sm font-medium tracking-wide">Rénovation de maison</span>
        ...
        <ScrollReveal direction="up" delay={0.2}>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-white leading-[0.95] mb-6">
            ...
            <span className="block mt-2">votre habitat<span className="text-accent">.</span></span>
          </h1>
        </ScrollReveal>
        ...
        <ScrollReveal direction="up" delay={0.3}>
          ...
          <p className="text-base sm:text-lg text-white/50 max-w-xl mx-auto mb-10">
            Rénovation Globale · Rénovation Énergétique
          </p>
        </ScrollReveal>
