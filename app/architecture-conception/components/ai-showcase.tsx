        ...
        <ScrollReveal direction="up">
          <div className="text-center mb-16 lg:mb-20">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 border border-accent/20 mb-6">
              ...
              <span className="text-accent text-sm font-medium">Technologie exclusive</span>
            </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-16">
          ...
          <ScrollReveal direction="right" delay={0.2}>
            <div className="relative">
              {/* Device frame */}
              <div className="relative aspect-[4/3] rounded-3xl overflow-hidden bg-gradient-to-br from-slate-900 to-slate-800 border border-white/10 shadow-2xl">
                {/* Screen content */}
                <div className="absolute inset-4 rounded-2xl bg-gradient-to-br from-accent/20 to-accent/10 overflow-hidden">
                  {/* Mock UI */}
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-br from-accent to-accent/80 flex items-center justify-center">
                ...
                {/* Glow effect */}
                <div className="absolute -inset-4 bg-gradient-to-r from-violet-500/20 via-fuchsia-500/20 to-cyan-500/20 blur-3xl opacity-50" />
              </div>

              {/* Floating badges */}
              <div className="absolute -top-4 -right-4 px-4 py-2 rounded-xl bg-violet-500 text-white text-sm font-semibold shadow-lg">
            ...
            <div className="space-y-6">
              {aiCapabilities.map((cap, i) => {
                ...
                return (
                  <div 
                    key={i}
                    className="group p-6 rounded-2xl bg-muted/30 border border-border/50 hover:border-violet-500/30 hover:shadow-lg transition-all duration-300"
                  >
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-violet-500 to-fuchsia-500 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                        <Icon className="w-6 h-6 text-white" />
                      </div>
                      <div className="flex-1">
                        <h3 className="font-bold text-primary mb-2">{cap.title}</h3>
                        <p className="text-foreground/60 text-sm mb-3">{cap.description}</p>
        ...
        <ScrollReveal direction="up" delay={0.4}>
          <div className="text-center">
            ...
            <Link 
              ...
              className="group inline-flex items-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-semibold transition-all duration-300 hover:shadow-xl hover:shadow-violet-500/30 hover:scale-105"
            >
