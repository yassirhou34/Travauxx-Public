  ...
  return (
    <section className="relative py-20 sm:py-28 lg:py-36 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5" style={{
        backgroundImage: `linear-gradient(rgba(232,50,99,0.3) 1px, transparent 1px), linear-gradient(90deg, rgba(232,50,99,0.3) 1px, transparent 1px)`,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <ScrollReveal direction="up">
          <div className="text-center mb-16 lg:mb-24">
            ...
            <p className="text-white/60 text-lg max-w-2xl mx-auto">
              Chaque projet commence par une réflexion architecturale solide. 
              Voici les étapes clés de notre phase de conception.
            </p>
          </div>
        </ScrollReveal>
            ...
            return (
              <ScrollReveal key={i} direction="up" delay={i * 0.1}>
                <div className="group relative h-full">
                  {/* Card */}
                  <div className="relative h-full p-6 lg:p-8 rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-violet-500/30 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:shadow-violet-500/10">
                    {/* Number */}
                    <div className="absolute -top-3 -right-3 w-12 h-12 rounded-full bg-gradient-to-br from-violet-500 to-fuchsia-500 flex items-center justify-center shadow-lg">
                      <span className="text-white font-bold text-sm">{step.number}</span>
                    </div>

                    {/* Icon */}
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-violet-500/20 to-fuchsia-500/20 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
        ...
        <ScrollReveal direction="up" delay={0.5}>
          <div className="mt-16 lg:mt-20 p-8 lg:p-12 rounded-3xl bg-gradient-to-r from-violet-500/10 to-fuchsia-500/10 backdrop-blur-sm border border-violet-500/20">
